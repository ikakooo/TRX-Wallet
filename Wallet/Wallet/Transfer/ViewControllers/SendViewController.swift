...
class SendViewController: FormViewController {
    ...
    init(
        ...
        form = Section()
            ...
            <<< AppFormAppearance.textFieldFloat(tag: Values.address) {
                ...
                cell.textField.placeholder = NSLocalizedString("send.recipientAddress.textField.placeholder", value: "Recipient TrustCore.Address", comment: "")
    ...
    @objc func send() {
        ...
        guard let address = TrustCore.Address(string: addressString) else {
